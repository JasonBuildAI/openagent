...
// casdoorAvailable matches controllers-layer "Casdoor fully initialized" state.
// Set by account.InitAuthConfig when Casdoor endpoint + application + cert succeed.
